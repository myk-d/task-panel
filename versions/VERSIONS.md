...
### 📦 Download build
- **Windows:** [myslennya-tasks-0.1.0.exe](./versions/v0.1.0/myslennya-tasks-0.1.0.exe)
- **macOS (планується):** ⏳ буде додано у v0.1.1
...
| Версія | Статус | Ключові фічі |
|:-------|:--------|:--------------|
| **v0.1.1** | 🧩 In progress | macOS `.dmg` build, auto-position fix |
| **v0.2.0** | 🧭 Planned | Імпорт / експорт задач, статистика, теми |
| **v0.3.0** | 💡 Idea | Синхронізація з календарем |
| **v1.0.0** | 🚀 Future | Аналітика, бекапи, звіти, dark/light themes |

---

📅 **Оновлено:** 2025-10-05  
✍️ **Автор:** [Mykola Dzoban](https://github.com/<your-username>)
